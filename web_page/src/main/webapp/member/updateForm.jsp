...
<form name="updateForm">
	<table border="1">
	    ...
	    <tr>
	        <th>이메일</th>
	        <td>
	        	<input type="email" name="email1" value="${list[0].email1 }">
	        	@
	    ...
	    <tr>
	        ...
	        <td>
	            <select name="tel1">
		         ...
		         -
		         <input type="text" name="tel2" size="4" maxlength="4" value="${list[0].tel2 }">
		         -
		         <input type="text" name="tel3" size="4" maxlength="4" value="${list[0].tel3 }">
			</td>
	    </tr>
